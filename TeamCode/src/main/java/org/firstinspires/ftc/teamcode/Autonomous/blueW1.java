...
import static org.firstinspires.ftc.teamcode.AutoConstants.Blue.STACK_BD_1_A;
import static org.firstinspires.ftc.teamcode.AutoConstants.Blue.STACK_C;
import static org.firstinspires.ftc.teamcode.AutoConstants.Blue.W_BD_ONE_OFF;
import static org.firstinspires.ftc.teamcode.AutoConstants.Blue.W_BD_TWO_OFF;
import static org.firstinspires.ftc.teamcode.AutoConstants.Blue.W_BD_THREE_OFF;
...
@Autonomous
public class blueW1 extends OpMode {
    ...
    public void init() {
        ...
        //W Blue LEFT 2+1 Auto (Park in Center)
        ...
        toCStackFromSpikeL = rejat.actionBuilder(W_SPIKE_ONE)
                .splineToLinearHeading(STACK_C, Pi/2)
                .build();
        toBDFromCStackAAL = rejat.actionBuilder(STACK_C)
                .setReversed(true)
                .splineToLinearHeading(STACK_BD_1_A, Pi/2)
                .build();
        toBDFromCStackABL = rejat.actionBuilder(STACK_BD_1_A)
                .splineToLinearHeading(W_BD_ONE_OFF, Pi/2)
                .build();
        toParkFromWL = rejat.actionBuilder(W_BD_ONE_OFF)
                .splineToLinearHeading(PARK_CENTER, Pi/2)
                .build();
        //W Blue Middle 2+1 Auto (Park in Center)
        ...
        toCStackFromSpikeM = rejat.actionBuilder(W_SPIKE_TWO_ALT)
                .splineToLinearHeading(STACK_C, Pi/2)
                .build();
        toBDFromCStackAAM = rejat.actionBuilder(STACK_C)
                .setReversed(true)
                .splineToLinearHeading(STACK_BD_1_A, Pi/2)
                .build();
        toBDFromCStackABM = rejat.actionBuilder(STACK_BD_1_A)
                .splineToLinearHeading(W_BD_TWO_OFF, Pi/2)
                .build();
        toParkFromWM = rejat.actionBuilder(W_BD_TWO_OFF)
                .splineToLinearHeading(PARK_CENTER, Pi/2)
                .build();
        //W Blue Right 2+1 Auto (Park in Center)
        ...
        toCStackFromSpikeR = rejat.actionBuilder(W_SPIKE_THREE)
                .splineToLinearHeading(STACK_C, Pi/2)
                .build();
        toBDFromCStackAAR = rejat.actionBuilder(STACK_C)
                .setReversed(true)
                .splineToLinearHeading(STACK_BD_1_A, Pi/2)
                .build();
